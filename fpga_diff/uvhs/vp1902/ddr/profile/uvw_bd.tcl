proc run_bd { ADDR_WIDTH DATA_WIDTH ID_WIDTH WR_OUTSTANDING RD_OUTSTANDING ECC_EN IP_LOCATION PLATFORM_PART IP_NAME} {
################################################################################
...
################################################################################
    ...
    create_project design_1_wrapper design_1_wrapper -part $part
    source $tclDir/run_src_manage_bd.tcl
