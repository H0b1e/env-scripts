...
proc create_hier_cell_qdma_0_support { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/qdma_0_support/gt_quad_0/TX0_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_TX0.0 /qdma_0_support/gt_quad_0/TX1_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_TX1.1\
/qdma_0_support/gt_quad_0/TX2_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_TX2.2 /qdma_0_support/gt_quad_0/TX3_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_TX3.3 /qdma_0_support/gt_quad_0/RX0_GT_IP_Interface\
xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_RX0.0 /qdma_0_support/gt_quad_0/RX1_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_RX1.1 /qdma_0_support/gt_quad_0/RX2_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_RX2.2\
/qdma_0_support/gt_quad_0/RX3_GT_IP_Interface xdma_ep_pcie_phy_0./qdma_0_support/pcie_phy/GT_RX3.3} \
    CONFIG.GT_TYPE {GTYP} \
...
MULTI RX_BUFFER_RESET_ON_CB_CHANGE ENABLE RX_BUFFER_RESET_ON_COMMAALIGN DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET K28.5 RX_COMMA_VALID_ONLY 0} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/qdma_0_support/gt_quad_0 {/qdma_0_support/gt_quad_0 xdma_ep_pcie_phy_0.IP_CH0,xdma_ep_pcie_phy_0.IP_CH1,xdma_ep_pcie_phy_0.IP_CH2,xdma_ep_pcie_phy_0.IP_CH3\
MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/qdma_0_support/gt_quad_0 {/qdma_0_support/gt_quad_0 xdma_ep_pcie_phy_0.IP_CH0,xdma_ep_pcie_phy_0.IP_CH1,xdma_ep_pcie_phy_0.IP_CH2,xdma_ep_pcie_phy_0.IP_CH3\
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $TO_DIFFTEST_PCIE_CLK
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_ports XDMA_AXI_LITE]
  connect_bd_intf_net -intf_net pcie_cfg_control_1 [get_bd_intf_pins qdma_0_support/pcie_cfg_control] [get_bd_intf_pins xdma_0/pcie_cfg_control_if]
  connect_bd_intf_net -intf_net pcie_cfg_interrupt_1 [get_bd_intf_pins qdma_0_support/pcie_cfg_interrupt] [get_bd_intf_pins xdma_0/pcie4_cfg_interrupt]
  connect_bd_intf_net -intf_net pcie_ep_gt_ref_1 [get_bd_intf_ports pcie_ep_gt_ref] [get_bd_intf_pins qdma_0_support/pcie_refclk]
  connect_bd_intf_net -intf_net qdma_0_support_m_axis_cq [get_bd_intf_pins qdma_0_support/m_axis_cq] [get_bd_intf_pins xdma_0/m_axis_cq]
  connect_bd_intf_net -intf_net qdma_0_support_m_axis_rc [get_bd_intf_pins qdma_0_support/m_axis_rc] [get_bd_intf_pins xdma_0/m_axis_rc]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_cfg_fc [get_bd_intf_pins qdma_0_support/pcie_cfg_fc] [get_bd_intf_pins xdma_0/pcie_cfg_fc]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_cfg_mesg_rcvd [get_bd_intf_pins qdma_0_support/pcie_cfg_mesg_rcvd] [get_bd_intf_pins xdma_0/pcie4_cfg_mesg_rcvd]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_cfg_mesg_tx [get_bd_intf_pins qdma_0_support/pcie_cfg_mesg_tx] [get_bd_intf_pins xdma_0/pcie4_cfg_mesg_tx]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_cfg_status [get_bd_intf_pins qdma_0_support/pcie_cfg_status] [get_bd_intf_pins xdma_0/pcie_cfg_status_if]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_mgt [get_bd_intf_ports pcie_mgt] [get_bd_intf_pins qdma_0_support/pcie_mgt]
  connect_bd_intf_net -intf_net qdma_0_support_pcie_transmit_fc [get_bd_intf_pins qdma_0_support/pcie_transmit_fc] [get_bd_intf_pins xdma_0/pcie_transmit_fc]
  connect_bd_intf_net -intf_net s_axis_cc_1 [get_bd_intf_pins qdma_0_support/s_axis_cc] [get_bd_intf_pins xdma_0/s_axis_cc]
  connect_bd_intf_net -intf_net s_axis_rq_1 [get_bd_intf_pins qdma_0_support/s_axis_rq] [get_bd_intf_pins xdma_0/s_axis_rq]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs XDMA_AXI_LITE/Reg] -force
