...
module SRAMTemplate(	// src/main/scala/utils/SRAMTemplate.scala:68:7
  ...
  wire [72:0] _array_ext_RW0_rdata;	// src/main/scala/utils/SRAMTemplate.scala:76:26
  ...
  wire [72:0] _rdata_T_0 = rdata_REG ? _array_ext_RW0_rdata : rdata_r0;	// src/main/scala/utils/Hold.scala:23:{48,65}, :28:106, src/main/scala/utils/SRAMTemplate.scala:76:26
  always @(posedge clock) begin	// src/main/scala/utils/SRAMTemplate.scala:68:7
    if (reset) begin	// src/main/scala/utils/SRAMTemplate.scala:68:7
      ...
      rdata_r0 <= 73'h0;	// src/main/scala/utils/Hold.scala:23:65, src/main/scala/utils/SRAMTemplate.scala:92:22
    end
      ...
      if (rdata_REG)	// src/main/scala/utils/Hold.scala:28:106
        rdata_r0 <= _array_ext_RW0_rdata;	// src/main/scala/utils/Hold.scala:23:65, src/main/scala/utils/SRAMTemplate.scala:76:26
    end
  ...
  array_512x73 array_ext (	// src/main/scala/utils/SRAMTemplate.scala:76:26
