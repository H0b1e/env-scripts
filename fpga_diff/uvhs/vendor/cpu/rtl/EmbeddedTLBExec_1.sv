...
module EmbeddedTLBExec_1(	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:177:7
  ...
  wire        hitLoad =
    hitCheck & (_hitMeta_T_10[1] | io_pf_status_mxr & _hitMeta_T_10[3]);	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:220:{22,44,70}, :222:38, :231:{39,86}, :234:{41,55,72}
  wire        _loadPF_T_9 =
    ~hitLoad & ~(io_in_bits_cmd[0]) & ~(io_in_bits_cmd[3]) & hit & ~isAMO__bore;	// src/main/scala/bus/simplebus/SimpleBus.scala:73:{18,26,29,33}, :74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :234:41, :247:{15,24,40,47,50}
  wire        _storePF_T_13 =
    ~(hitCheck & _hitMeta_T_10[2]) & io_in_bits_cmd[0] & hit | ~hitLoad
    & ~(io_in_bits_cmd[0]) & ~(io_in_bits_cmd[3]) & hit & isAMO__bore;	// src/main/scala/bus/simplebus/SimpleBus.scala:73:{18,26,29,33}, :74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :220:{22,44,70}, :222:38, :231:{39,86}, :234:41, :235:42, :247:15, :248:{17,27,44,52,65,81,88}
  ...
  wire        _GEN_5 =
    ...
    | ~(permCheck & io_mem_resp_bits_rdata[2]) & io_in_bits_cmd[0];	// src/main/scala/bus/simplebus/SimpleBus.scala:73:{18,26,29,33}, :74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:261:49, :320:{38,86}, :323:{47,62,79}, :324:48, :337:{19,29,46,50,61}
  ...
  assign io_out_valid_0 =
    io_in_valid & (hit & ~hitWB ? ~(_io_isFinish_T_1 | loadPF | storePF) : state == 3'h4);	// src/main/scala/nutcore/Bundle.scala:131:23, src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :226:{19,81}, :247:12, :248:13, :253:22, :275:18, :342:27, :387:{31,37,42,45,53,68,78,97}
          ...
          if (io_mem_resp_valid) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:178:14
            if (needFlush)	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:266:26
              ...
              state <=
                _GEN_5
                  ? 3'h5
                  : ~(io_mem_resp_bits_rdata[6]) | ~(io_mem_resp_bits_rdata[7])
                    & io_in_bits_cmd[0]
                      ? 3'h3
                      : 3'h4;	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:253:22, :261:49, :305:73, :325:{60,72,76,88}, :337:{46,80}, :338:21, :342:{21,27}
          end
        end
