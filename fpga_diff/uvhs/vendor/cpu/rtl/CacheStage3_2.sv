...
module CacheStage3_2(	// src/main/scala/nutcore/mem/Cache.scala:235:14
  ...
  wire        meta_dirty =
    ...
    | io_in_bits_waymask[3] & io_in_bits_metas_3_dirty;	// src/main/scala/nutcore/mem/Cache.scala:264:19
  wire [16:0] meta_tag =
    ...
    | (io_in_bits_waymask[3] ? io_in_bits_metas_3_tag : 17'h0);	// src/main/scala/nutcore/mem/Cache.scala:264:19
  wire [63:0] dataRead =
  ...
  wire        _GEN = _dataHitWriteBus_x3_T | _dataHitWriteBus_x3_T_1;	// src/main/scala/bus/simplebus/SimpleBus.scala:78:27, src/main/scala/nutcore/mem/Cache.scala:279:{32,60}
  ...
  wire        metaHitWriteBus_x5 = hitWrite & ~meta_dirty;	// src/main/scala/nutcore/mem/Cache.scala:264:19, :283:22, :289:{22,25}
  ...
  wire [63:0] io_mem_req_bits_wdata_0 =
    ...
    | (io_in_bits_waymask[3] ? dataWay_3_data : 64'h0);	// src/main/scala/nutcore/mem/Cache.scala:264:19, :308:26, :309:25
  ...
  wire        _io_dataReadRespToL1_T_3 = state2 == 2'h2;	// src/main/scala/nutcore/mem/Cache.scala:304:23, :329:89
  ...
  wire        readingFirst = ~afterFirstRead & io_mem_resp_valid & _io_out_valid_T_8;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :338:{22,38,58,68}
  reg  [63:0] inRdataRegDemand;	// src/main/scala/nutcore/mem/Cache.scala:339:35
  wire        _io_dataReadRespToL1_T = state == 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :343:31
  wire        io_cohResp_valid =
    _io_dataReadRespToL1_T & probe | _io_dataReadRespToL1_T_2 & _io_dataReadRespToL1_T_3;	// src/main/scala/nutcore/mem/Cache.scala:262:39, :306:66, :329:89, :343:{31,43,53}, :344:46
  ...
  wire        _respToL1Last_T_5 =
    (_io_dataReadRespToL1_T | _io_dataReadRespToL1_T_2 & _io_dataReadRespToL1_T_3)
    & hitReadBurst;	// src/main/scala/nutcore/mem/Cache.scala:263:26, :306:66, :329:89, :343:31, :351:{48,71,96}
  ...
  wire        _GEN_1 = _io_out_valid_T_8 & io_mem_resp_valid;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :338:68, :353:18, :385:31, :386:24
  wire [63:0] _dataRefill_T =
    readingFirst & io_in_bits_req_cmd[0] ? _wordMask_T_19 : 64'h0;	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/nutcore/mem/Cache.scala:276:21, :338:{38,58}, :402:67, src/main/scala/utils/BitUtils.scala:27:26
  ...
  wire        metaRefillWriteBus_req_valid =
    _io_out_valid_T_8 & io_mem_resp_valid & _io_out_bits_cmd_T;	// src/main/scala/bus/simplebus/SimpleBus.scala:91:24, src/main/scala/nutcore/mem/Cache.scala:338:68, :412:{39,59}
  wire        _GEN_2 = _GEN_1 & _io_out_valid_T_11;	// src/main/scala/bus/simplebus/SimpleBus.scala:76:27, src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24, :422:57
  wire        _GEN_3 = hitReadBurst & _io_dataReadRespToL1_T_2;	// src/main/scala/nutcore/mem/Cache.scala:263:26, :306:66, :430:30
  ...
  always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
    ...
    if (reset) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
      ...
      automatic logic _io_mmio_req_valid_T;	// src/main/scala/nutcore/mem/Cache.scala:334:31
      automatic logic _GEN_5;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18
      _GEN_4 = io_mem_req_ready & io_mem_req_valid_0;	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35, src/main/scala/nutcore/mem/Cache.scala:329:48
      _io_mmio_req_valid_T = state == 4'h5;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :334:31
      _GEN_5 =
        _io_mmio_req_valid_T | _inRdataRegDemand_T_1 | _io_dataReadRespToL1_T_2
        | _io_mem_req_valid_T;	// src/main/scala/nutcore/mem/Cache.scala:306:66, :322:23, :334:31, :336:31, :340:52, :353:18
      if (_io_dataReadRespToL1_T | _GEN_5
          | ~(_io_out_valid_T_8 & io_mem_resp_valid & _dataHitWriteBus_x3_T)) begin	// src/main/scala/nutcore/mem/Cache.scala:279:{32,83}, :336:31, :338:68, :343:31, :353:18, :385:31, :388:{52,75}
        if (io_out_valid_0 & _GEN)	// src/main/scala/nutcore/mem/Cache.scala:279:{20,60}, :445:31
        ...
        writeL2BeatCnt_value <= 3'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40
      if (_io_dataReadRespToL1_T) begin	// src/main/scala/nutcore/mem/Cache.scala:343:31
        if (probe) begin	// src/main/scala/nutcore/mem/Cache.scala:262:39
          if (io_cohResp_valid) begin	// src/main/scala/nutcore/mem/Cache.scala:343:53
            state <= {hit, 3'h0};	// src/main/scala/nutcore/mem/Cache.scala:260:25, :294:22, :360:23
          ...
          state <= mmio ? 4'h5 : {2'h0, meta_dirty, 1'h1};	// src/main/scala/nutcore/mem/Cache.scala:235:14, :259:26, :264:19, :294:22, :367:{21,42}
      end
      else if (~(_io_mmio_req_valid_T | _inRdataRegDemand_T_1)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/nutcore/mem/Cache.scala:334:31, :340:52, :353:18
        if (_io_dataReadRespToL1_T_2) begin	// src/main/scala/nutcore/mem/Cache.scala:306:66
          if (probe & io_cohResp_valid & releaseLast | respToL1Fire & respToL1Last)	// src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/nutcore/mem/Cache.scala:262:39, :343:53, :350:51, :376:{19,38,53,69}
            state <= 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22
        ...
        else begin	// src/main/scala/nutcore/mem/Cache.scala:322:23
          if (_io_out_valid_T_8) begin	// src/main/scala/nutcore/mem/Cache.scala:338:68
            ...
            if ((&{cmd[2], cmd[0]}) & _GEN_4)	// src/main/scala/bus/simplebus/SimpleBus.scala:65:14, :78:27, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35, src/main/scala/nutcore/mem/Cache.scala:322:16, :395:43
            ...
            state <= 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22
          if (_GEN_1)	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
            readBeatCnt_value <= readBeatCnt_value + 3'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
        end
      end
      if (_io_dataReadRespToL1_T | _io_mmio_req_valid_T | _inRdataRegDemand_T_1
          | _io_dataReadRespToL1_T_2 | _io_mem_req_valid_T | _io_out_valid_T_8
          | ~(_io_mem_req_valid_T_1 & _GEN_4)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:15, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35, src/main/scala/nutcore/mem/Cache.scala:306:{39,66}, :322:23, :334:31, :338:68, :340:52, :343:31, :353:18, :394:30
      end
      ...
      if (_GEN_0) begin	// src/main/scala/nutcore/mem/Cache.scala:306:92
        ...
        state2 <= 2'h2;	// src/main/scala/nutcore/mem/Cache.scala:304:23
      else if (state2 == 2'h2 & (_GEN_4 | io_cohResp_valid | hitReadBurst))	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35, src/main/scala/nutcore/mem/Cache.scala:263:26, :304:23, :311:19, :314:{44,63,96,105}, :343:53
        state2 <= 2'h0;	// src/main/scala/nutcore/mem/Cache.scala:304:23
      afterFirstRead <= ~_io_dataReadRespToL1_T & (~_GEN_5 & _GEN_1 | afterFirstRead);	// src/main/scala/nutcore/mem/Cache.scala:336:31, :337:33, :343:31, :353:18, :355:22, :356:22, :385:31, :386:24
      alreadyOutFire <= ~_io_dataReadRespToL1_T & (io_out_valid_0 | alreadyOutFire);	// src/main/scala/nutcore/mem/Cache.scala:337:33, :343:31, :353:18, :356:22, :445:31
      if (_releaseLast_T_2)	// src/main/scala/nutcore/mem/Cache.scala:346:49
        releaseLast_c_value <= releaseLast_c_value + 3'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
    ...
    if (mmio ? _inRdataRegDemand_T_1 : readingFirst)	// src/main/scala/nutcore/mem/Cache.scala:259:26, :338:{38,58}, :340:{39,52}
      inRdataRegDemand <= mmio ? 64'h0 : io_mem_resp_bits_rdata;	// src/main/scala/nutcore/mem/Cache.scala:259:26, :339:{35,39}
  end // always @(posedge)
  ...
  Arbiter2_SRAMBundleAW_4 metaWriteArb (	// src/main/scala/nutcore/mem/Cache.scala:254:28
    ...
    .io_in_0_bits_setIdx     (io_in_bits_req_addr[14:6]),	// src/main/scala/nutcore/mem/Cache.scala:258:31
    ...
    .io_in_1_bits_setIdx     (io_in_bits_req_addr[14:6]),	// src/main/scala/nutcore/mem/Cache.scala:258:31
  ...
  assign io_in_ready = _io_dataReadRespToL1_T & ~hitReadBurst & ~miss & ~probe;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :261:26, :262:39, :263:26, :343:31, :458:{52,55,70,73,79,82}
  ...
  assign io_out_bits_cmd =
    _GEN_2
      ...
      : _GEN_3 ? {1'h0, respToL1Last, 2'h2} : io_in_bits_req_cmd;	// src/main/scala/bus/simplebus/SimpleBus.scala:91:24, src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/nutcore/mem/Cache.scala:235:14, :422:{57,79}, :425:23, :426:75, :430:{30,54}, :433:23, :436:23
  assign io_out_bits_rdata =
    _GEN_2
      ? dataRefill
      : _GEN
          ? (hit ? dataRead : inRdataRegDemand)
          : _GEN_3 ? io_mem_req_bits_wdata_0 : hit ? dataRead : inRdataRegDemand;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :260:25, :275:21, :279:60, :309:25, :339:35, :422:{57,79}, :424:25, :426:75, :428:{25,31}, :430:{30,54}, :432:25, :435:{25,31}, src/main/scala/utils/BitUtils.scala:34:26
  assign io_isFinish =
    probe
      ? io_cohResp_valid
        & (miss ? _io_dataReadRespToL1_T : _io_dataReadRespToL1_T_2 & releaseLast)
      : hit | io_in_bits_req_cmd[0]
          ? io_out_valid_0
          : _io_isFinish_T_9 & (io_out_valid_0 | alreadyOutFire);	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/nutcore/mem/Cache.scala:235:14, :260:25, :261:26, :262:39, :306:66, :337:33, :343:{31,53}, :445:31, :446:48, :454:{21,45,51,98}, :455:{8,13,68,84}
  ...
  assign io_mem_req_bits_addr =
    _io_mem_req_valid_T
      ...
      : {meta_tag, io_in_bits_req_addr[14:6], 6'h0};	// src/main/scala/nutcore/mem/Cache.scala:235:14, :258:31, :264:19, :318:{35,44}, :321:18, :322:23, :324:35
  ...
  assign io_mem_req_bits_wdata = io_mem_req_bits_wdata_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :309:25
  assign io_dataReadRespToL1 =
    hitReadBurst
    & (_io_dataReadRespToL1_T | _io_dataReadRespToL1_T_2 & _io_dataReadRespToL1_T_3);	// src/main/scala/nutcore/mem/Cache.scala:235:14, :263:26, :306:66, :329:89, :343:31, :459:{39,76,99}
endmodule
