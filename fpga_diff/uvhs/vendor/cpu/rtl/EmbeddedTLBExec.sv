...
module EmbeddedTLBExec(	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:177:7
  ...
  assign hitinstrPF =
    ~(hit & ~(_permCheck_T & ~(_hitMeta_T_10[4])) & ~(_permCheck_T_5 & _hitMeta_T_10[4])
      & _hitMeta_T_10[3]) & hit;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :220:{22,44,70}, :222:38, :231:{39,42,61,71,74,86,89,108,118}, :233:41, :245:{42,52}
  ...
  assign io_out_valid_0 = io_in_valid & (hit & ~_hitWB_T_7 | state == 3'h4);	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :226:{19,66}, :253:22, :305:43, :387:{31,37,42,45,97}
  always @(posedge clock) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:177:7
    ...
    if (reset) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:177:7
      ...
      automatic logic permExec;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:320:{38,86}, :322:47
      ...
      permExec =
        ...
        & ~(_permCheck_T_5 & io_mem_resp_bits_rdata[4]) & io_mem_resp_bits_rdata[3];	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:231:{61,108}, :261:49, :320:{38,41,70,73,86,89,118}, :322:47
        ...
        if (_GEN_2) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:275:18
          ...
          if (io_mem_resp_valid) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:178:14
            if (isFlush)	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:268:27
              ...
              state <= ~permExec | io_mem_resp_bits_rdata[6] ? 3'h4 : 3'h3;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:253:22, :261:49, :305:43, :320:{38,86}, :322:47, :330:{30,58}, :332:21
          end
        end
      ...
      if (~_GEN_8) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:259:32, :260:32, :275:18
        if (_GEN_3) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:275:18
          if (~io_mem_resp_valid | isFlush) begin	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:268:27, :272:24, :299:31, :300:24
            ...
            missIPF <= _GEN_4 ? _GEN_5 | missIPF : (|level) & ~permExec | missIPF;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:254:22, :272:24, :303:{49,82}, :304:{28,60}, :306:45, :319:{27,36}, :320:{38,86}, :322:47, :330:{19,30,40}
        end
      ...
      REG <=
        ...
        & ~(|state) & ~isFlush;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:226:{19,66}, :253:22, :254:22, :259:32, :260:32, :262:18, :268:27, :269:27, :275:18, :299:31, :300:24, :303:82, :319:{27,36}, :320:{38,86}, :322:47, :330:30, :374:77, :378:{33,50,63,73,93}
    end
