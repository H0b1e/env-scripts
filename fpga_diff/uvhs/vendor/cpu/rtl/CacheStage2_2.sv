...
module CacheStage2_2(	// src/main/scala/nutcore/mem/Cache.scala:162:14
  ...
  wire        isForwardMeta =
    ...
    & io_metaWriteBus_req_bits_setIdx == io_in_bits_req_addr[14:6];	// src/main/scala/nutcore/mem/Cache.scala:174:31, :176:{35,64,99}
  ...
  wire [3:0]  hitVec =
    {metaWay_3_valid & metaWay_3_tag == io_in_bits_req_addr[31:15] & io_in_valid,
     ...
     metaWay_0_valid & metaWay_0_tag == io_in_bits_req_addr[31:15] & io_in_valid};	// src/main/scala/nutcore/mem/Cache.scala:174:31, :187:22, :190:{49,59,73,90}
  ...
  wire        isForwardData =
    ...
    & io_dataWriteBus_req_bits_setIdx == io_in_bits_req_addr[14:3];	// src/main/scala/nutcore/mem/Cache.scala:78:35, :174:31, :216:35, :217:{13,30}
  ...
  assign io_out_bits_mmio =
    ...
    | {io_in_bits_req_addr[31:30], io_in_bits_req_addr[29:12] ^ 18'h310B0} == 20'h0;	// src/main/scala/nutcore/NutCore.scala:87:{11,24,44}, :88:15, src/main/scala/nutcore/mem/Cache.scala:162:14, :194:34
