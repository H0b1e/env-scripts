...
module NutShell(	// src/test/scala/TopMain.scala:39:7
  input           clock,	// src/test/scala/TopMain.scala:39:7
                  reset,	// src/test/scala/TopMain.scala:39:7
  ...
  input  [1:0]    io_meip,	// src/main/scala/system/NutShell.scala:45:14
  ...
  wire        _plic_io_in_awready;	// src/main/scala/system/NutShell.scala:121:20
  wire        _plic_io_in_wready;	// src/main/scala/system/NutShell.scala:121:20
  wire        _plic_io_in_bvalid;	// src/main/scala/system/NutShell.scala:121:20
  wire        _plic_io_in_arready;	// src/main/scala/system/NutShell.scala:121:20
  wire        _plic_io_in_rvalid;	// src/main/scala/system/NutShell.scala:121:20
  wire [63:0] _plic_io_in_rdata;	// src/main/scala/system/NutShell.scala:121:20
  ...
  wire        _clint_io_in_awready;	// src/main/scala/system/NutShell.scala:114:21
  wire        _clint_io_in_wready;	// src/main/scala/system/NutShell.scala:114:21
  wire        _clint_io_in_bvalid;	// src/main/scala/system/NutShell.scala:114:21
  wire        _clint_io_in_arready;	// src/main/scala/system/NutShell.scala:114:21
  wire        _clint_io_in_rvalid;	// src/main/scala/system/NutShell.scala:114:21
  wire [63:0] _clint_io_in_rdata;	// src/main/scala/system/NutShell.scala:114:21
  ...
  wire        _mmioXbar_io_out_2_req_valid;	// src/main/scala/system/NutShell.scala:107:24
  wire [31:0] _mmioXbar_io_out_2_req_bits_addr;	// src/main/scala/system/NutShell.scala:107:24
  wire [2:0]  _mmioXbar_io_out_2_req_bits_size;	// src/main/scala/system/NutShell.scala:107:24
  wire [3:0]  _mmioXbar_io_out_2_req_bits_cmd;	// src/main/scala/system/NutShell.scala:107:24
  wire [7:0]  _mmioXbar_io_out_2_req_bits_wmask;	// src/main/scala/system/NutShell.scala:107:24
  wire [63:0] _mmioXbar_io_out_2_req_bits_wdata;	// src/main/scala/system/NutShell.scala:107:24
  wire        _mmioXbar_io_out_2_resp_ready;	// src/main/scala/system/NutShell.scala:107:24
  ...
  reg  [1:0]  plic_io_extra_intrVec_REG;	// src/main/scala/system/NutShell.scala:123:47
  reg  [1:0]  plic_io_extra_intrVec_REG_1;	// src/main/scala/system/NutShell.scala:123:39
  always @(posedge clock) begin	// src/test/scala/TopMain.scala:39:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/test/scala/TopMain.scala:39:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/test/scala/TopMain.scala:39:7
      `FIRRTL_BEFORE_INITIAL	// src/test/scala/TopMain.scala:39:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/test/scala/TopMain.scala:39:7
      automatic logic [31:0] _RANDOM[0:0];	// src/test/scala/TopMain.scala:39:7
      `ifdef INIT_RANDOM_PROLOG_	// src/test/scala/TopMain.scala:39:7
        `INIT_RANDOM_PROLOG_	// src/test/scala/TopMain.scala:39:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/test/scala/TopMain.scala:39:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// src/test/scala/TopMain.scala:39:7
        plic_io_extra_intrVec_REG = _RANDOM[/*Zero width*/ 1'b0][1:0];	// src/main/scala/system/NutShell.scala:123:47, src/test/scala/TopMain.scala:39:7
        plic_io_extra_intrVec_REG_1 = _RANDOM[/*Zero width*/ 1'b0][3:2];	// src/main/scala/system/NutShell.scala:123:{39,47}, src/test/scala/TopMain.scala:39:7
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/test/scala/TopMain.scala:39:7
      `FIRRTL_AFTER_INITIAL	// src/test/scala/TopMain.scala:39:7
  ...
  SimpleBus2AXI4Converter_1 io_mmio_bridge (	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24
    ...
    .io_in_req_valid       (_mmioXbar_io_out_2_req_valid),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_req_bits_addr   (_mmioXbar_io_out_2_req_bits_addr),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_req_bits_size   (_mmioXbar_io_out_2_req_bits_size),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_req_bits_cmd    (_mmioXbar_io_out_2_req_bits_cmd),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_req_bits_wmask  (_mmioXbar_io_out_2_req_bits_wmask),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_req_bits_wdata  (_mmioXbar_io_out_2_req_bits_wdata),	// src/main/scala/system/NutShell.scala:107:24
    .io_in_resp_ready      (_mmioXbar_io_out_2_resp_ready),	// src/main/scala/system/NutShell.scala:107:24
  ...
  SimpleBus2AXI4Converter_2 clint_io_in_bridge (	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24
    ...
    .io_out_awready       (_clint_io_in_awready),	// src/main/scala/system/NutShell.scala:114:21
    .io_out_awvalid       (_clint_io_in_bridge_io_out_awvalid),
    .io_out_awaddr   (_clint_io_in_bridge_io_out_awaddr),
    .io_out_wready        (_clint_io_in_wready),	// src/main/scala/system/NutShell.scala:114:21
    ...
    .io_out_bvalid        (_clint_io_in_bvalid),	// src/main/scala/system/NutShell.scala:114:21
    .io_out_arready       (_clint_io_in_arready),	// src/main/scala/system/NutShell.scala:114:21
    ...
    .io_out_rvalid        (_clint_io_in_rvalid),	// src/main/scala/system/NutShell.scala:114:21
    .io_out_rdata    (_clint_io_in_rdata)	// src/main/scala/system/NutShell.scala:114:21
  );	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24
  ...
  SimpleBus2AXI4Converter_2 plic_io_in_bridge (	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24
    ...
    .io_out_awready       (_plic_io_in_awready),	// src/main/scala/system/NutShell.scala:121:20
    .io_out_awvalid       (_plic_io_in_bridge_io_out_awvalid),
    .io_out_awaddr   (_plic_io_in_bridge_io_out_awaddr),
    .io_out_wready        (_plic_io_in_wready),	// src/main/scala/system/NutShell.scala:121:20
    ...
    .io_out_bvalid        (_plic_io_in_bvalid),	// src/main/scala/system/NutShell.scala:121:20
    .io_out_arready       (_plic_io_in_arready),	// src/main/scala/system/NutShell.scala:121:20
    ...
    .io_out_rvalid        (_plic_io_in_rvalid),	// src/main/scala/system/NutShell.scala:121:20
    .io_out_rdata    (_plic_io_in_rdata)	// src/main/scala/system/NutShell.scala:121:20
  );	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24
  assign io_mmio_awprot = 3'h1;	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24, src/main/scala/system/NutShell.scala:45:14, :114:21, :121:20, src/test/scala/TopMain.scala:39:7
  assign io_mmio_awid = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_awuser = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_awburst = 2'h1;	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24, src/test/scala/TopMain.scala:39:7
  assign io_mmio_awlock = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_awcache = 4'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_awqos = 4'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_arprot = 3'h1;	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24, src/main/scala/system/NutShell.scala:45:14, :114:21, :121:20, src/test/scala/TopMain.scala:39:7
  assign io_mmio_arid = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_aruser = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_arburst = 2'h1;	// src/main/scala/bus/simplebus/ToAXI4.scala:204:24, src/test/scala/TopMain.scala:39:7
  assign io_mmio_arlock = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_arcache = 4'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_mmio_arqos = 4'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_frontend_bresp = 2'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_frontend_bid = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_frontend_buser = 1'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_frontend_rresp = 2'h0;	// src/test/scala/TopMain.scala:39:7
  assign io_frontend_rid = _axi2sb_io_in_rid[0];	// src/main/scala/system/NutShell.scala:61:22, :62:16, src/test/scala/TopMain.scala:39:7
  assign io_frontend_ruser = 1'h0;	// src/test/scala/TopMain.scala:39:7
endmodule
