...
module uvw_stream_if (
    ...
    // -------------------------------------------------------------------
    // sync.
(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_start_addr                     ;
     reg    [ 63:0]                        r_size                           ;
(* MARK_DEBUG="true" *)     wire                                  s_wcmd                           ;
(* MARK_DEBUG="true" *)     wire                                  s_rcmd                           ;

    // stream -> axi4 (system bus -> IP)
(* MARK_DEBUG="true" *)     wire                                  s_dn_fifo_wen                    ;
    wire   [ 71:0]                        s_dn_fifo_wdata                  ;
(* MARK_DEBUG="true" *)     wire                                  s_dn_fifo_ren                    ;
    wire   [ 71:0]                        s_dn_fifo_rdata                  ;
(* MARK_DEBUG="true" *)     wire                                  s_dn_fifo_full                   ;
(* MARK_DEBUG="true" *)     wire                                  s_dn_fifo_empty                  ;
(* MARK_DEBUG="true" *)     wire   [  9:0]                        s_dn_fifo_dcnt                   ;
 
(* MARK_DEBUG="true" *)     reg    [  7:0]                        r_dn_fsm                         ;
(* MARK_DEBUG="true" *)     wire                                  s_busy                   		;
(* MARK_DEBUG="true" *)     reg                                   r_busy                           ;
(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_wr_size                        ;
(* MARK_DEBUG="true" *)     reg                                   r_wr_end                         ;
(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_axi_awaddr                     ;
(* MARK_DEBUG="true" *)     reg    [  7:0]                        r_axi_awlen                      ;
(* MARK_DEBUG="true" *)     reg                                   r_axi_awvalid                    ;
(* MARK_DEBUG="true" *)     wire                                  s_axi_wlast                      ;
(* MARK_DEBUG="true" *)     reg    [  8:0]                        r_awlen_cnt                      ;
(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_rd_size                        ;
(* MARK_DEBUG="true" *)     reg                                   r_rd_end                         ;
(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_axi_araddr                     ;
(* MARK_DEBUG="true" *)     reg    [  7:0]                        r_axi_arlen                      ;
(* MARK_DEBUG="true" *)     reg                                   r_axi_arvalid                    ;
(* MARK_DEBUG="true" *)     wire                                  s_axi_rready                     ;
(* MARK_DEBUG="true" *)     wire                                  s_axi_rlast                      ;

(* MARK_DEBUG="true" *)     // axi4 -> stream (IP -> system bus)
(* MARK_DEBUG="true" *)     wire                                  s_up_fifo_wen                    ;
     wire   [ 71:0]                        s_up_fifo_wdata                  ;
(* MARK_DEBUG="true" *)     wire                                  s_up_fifo_ren                    ;
     wire   [ 71:0]                        s_up_fifo_rdata                  ;
(* MARK_DEBUG="true" *)     wire                                  s_up_fifo_full                   ;
(* MARK_DEBUG="true" *)     wire                                  s_up_fifo_empty                  ;
(* MARK_DEBUG="true" *)     wire   [  9:0]                        s_up_fifo_dcnt                   ;

(* MARK_DEBUG="true" *)     reg    [ 63:0]                        r_up_size_cnt                    ;
(* MARK_DEBUG="true" *)     wire                                  s_up_end                         ;
...
// ================================================================================================
    ...
    sfifo_72bx512_fwft u_dn_fifo (
        ...
        .prog_full_thresh        (9'd500          ), // IN STD_LOGIC_VECTOR(8 DOWNTO 0);
