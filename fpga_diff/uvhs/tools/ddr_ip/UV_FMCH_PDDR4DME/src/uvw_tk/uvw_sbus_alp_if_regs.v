...
input      [29:0]  h2c_cache_fifo_sts_fifo_cnt,
...
always @* begin
   ...
   h2c_cache_fifo_sts_qq[29:0] = h2c_cache_fifo_sts_fifo_cnt;
...
always @* begin
   ...
   io_status_qq[3] = io_status_up_ip2wrap_tlast;
   io_status_qq[4] = io_status_up_ip2wrap_tvalid;
   io_status_qq[5] = io_status_up_wrap2ip_tready;
end
...
//VER:UV-IP-SBUS_IP0.4.0.xlsx:2025/2/7:uvw_sbus_alp_if:1:SBUS_ALP_IF:8:32::-1:
...
//REG:SRC_ADDRESS:source address for ALP:32:0x40:USER:VSBL:RET::1:4:0x00000000:0::
//FLD:SRC_ADDRESS:0:31:R:RW:0:
...
//REG:H2C_CACHE_FIFO_STS:FIFO COUNT:32:0x68:USER:VSBL:RET::1:4:0x80000000:0::
//FLD:FIFO_CNT:0:29:RW:R:0:
...
//FLD:UP_IP2WRAP_TLAST:3:3:RW:R:0:
//FLD:UP_IP2WRAP_TVALID:4:4:RW:R:0:
//FLD:UP_WRAP2IP_TREADY:5:5:RW:R:0:
