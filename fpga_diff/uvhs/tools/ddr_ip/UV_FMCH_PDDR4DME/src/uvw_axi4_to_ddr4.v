...
uvw_axi4_to_ddr4_secondary_top #(
    ...
    .p_ecc_en                           (p_ecc_en                               )) // 1 => ecc enable,0 => ecc disable
u_uvw_axi4_to_ddr4(
    // User logic
    ...
    .ddr4ip_ddr4_user_clk               (ddr4ip_ddr4_user_clk                   ), // (o)
    .ddr4ip_ddr4_user_rst               (ddr4ip_ddr4_user_rst                   ), // (o)
    ...
    // DDR4 mig
    .FP_CLK_200M_P                      (FP_CLK_200M_P                          ), // (i)
    .FP_CLK_200M_N                      (FP_CLK_200M_N                          ), // (i)
    .DDR4_DIMM_ACT_N                    (DDR4_DIMM_ACT_N                        ), // (o)
    .DDR4_DIMM_A                        (DDR4_DIMM_A                            ), // (o)
    .DDR4_DIMM_BA                       (DDR4_DIMM_BA                           ), // (o)
    .DDR4_DIMM_BG                       (DDR4_DIMM_BG                           ), // (o)
    .DDR4_DIMM_CK_N                     (DDR4_DIMM_CK_N                         ), // (o)
    .DDR4_DIMM_CK_P                     (DDR4_DIMM_CK_P                         ), // (o)
    .DDR4_DIMM_CKE                      (DDR4_DIMM_CKE                          ), // (o)
    .DDR4_DIMM_CS_N                     (DDR4_DIMM_CS_N                         ), // (o)
    .DDR4_DIMM_ODT                      (DDR4_DIMM_ODT                          ), // (o)
    .DDR4_DIMM_RST_B                    (DDR4_DIMM_RST_B                        ), // (o)
    .DDR4_DIMM_DM                       (DDR4_DIMM_DM                           ), // (io)
    .DDR4_DIMM_DQ                       (DDR4_DIMM_DQ                           ), // (io)
    .DDR4_DIMM_DQS_N                    (DDR4_DIMM_DQS_N                        ), // (io)
    .DDR4_DIMM_DQS_P                    (DDR4_DIMM_DQS_P                        )  // (io)
) ;
