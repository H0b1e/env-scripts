...
module uvw_ddr4_reg (
    ...
    // -------------------------------------------------------------------
    parameter                            IP_DATE           = 32'h20260119 ;
    parameter                            IP_VERSION        = 32'h00310004 ; // sysbus3.1
    parameter                            IP_TYPE           = 32'h00000008 ;

    parameter                            ADR_IP_TYPE       = 16'h0000     ;
    parameter                            ADR_BUS_CLEAR     = 16'h0008     ;
    parameter                            ADR_DATE          = 16'h0100     ;
    parameter                            ADR_VERSION       = 16'h0104     ;
...
// ================================================================================================
   ...
   assign ddr4_rcmd = r_rcmd;
    ...
    assign s_rd_data   = (reg_addr == ADR_IP_TYPE       ) ? IP_TYPE                                     :
                         ...
                         (reg_addr == ADR_DATE          ) ? IP_DATE                                     :
                         (reg_addr == ADR_VERSION       ) ? IP_VERSION                                  :
